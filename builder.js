...
const CONTAINERS = new Set(['ifBlock', 'repeatBlock', 'rowLoop', 'triggerGroup', 'conditionGroup', 'tryBlock', 'retryBlock', 'elementLoop', 'iframeBlock', 'groupBlock', 'actionGroup']);
...
function containerLabelFor(b) {
  ...
  if (b.type === 'actionGroup') return 'Műveletcsoport blokkjai';
