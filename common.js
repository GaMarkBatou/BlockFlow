const BF = (() => {
  ...
  const BLOCKS = {
    ...
    fill: { name: 'Beillesztés / kitöltés', desc: 'Szöveget ír mezőbe framework- és ServiceNow/SNOW-kompatibilis eseményekkel is.' },
    ...
    fieldByLabel: { name: 'Mező keresése címke alapján', desc: 'Enterprise/SNOW workspace felületeken label, aria, data attribútum és shadow DOM alapján mezőt keres.' },
